...
char remoteIP[] = "192.168.0.200"; // REPLACE with your laptop's IP address on your team's router hey
...
#define steering_angle_center 104  // REPLACE with team center angle for servor steering
int a_state;
