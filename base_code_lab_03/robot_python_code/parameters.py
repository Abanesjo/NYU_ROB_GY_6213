...
camera_matrix = np.array([[1.03300796e+03, 0.00000000e+00, 6.04851978e+02],
 [0.00000000e+00, 1.03249006e+03, 3.48292572e+02],
 [0.00000000e+00, 0.00000000e+00, 1.00000000e+00]], dtype=np.float32)

# dist_coeffs = np.array([-0.32511173, -0.09273864 ,-0.00295959 , 0.00111094 , 0.2446519 ], dtype=np.float32)
dist_coeffs = np.array([-3.51370750e-01, 2.19078471e-02, 1.32180552e-04, -3.89461301e-05, 8.39424410e-02], dtype=np.float32)
...
filename_start = './data_aruco/robot_data'
